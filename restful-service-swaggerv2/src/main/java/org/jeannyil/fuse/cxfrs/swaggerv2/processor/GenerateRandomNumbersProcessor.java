package org.jeannyil.fuse.cxfrs.swaggerv2.processor;

import org.apache.camel.Exchange;
import org.apache.camel.Message;
import org.apache.camel.Processor;
import org.jeannyil.fuse.cxfrs.swaggerv2.constants.GenerateNumbersParametersEnum;
import org.jeannyil.fuse.cxfrs.swaggerv2.exceptions.InputParameterValidationException;
import org.jeannyil.fuse.cxfrs.swaggerv2.model.RandomlyGeneratedNumber;
import org.jeannyil.fuse.cxfrs.swaggerv2.model.Response;
...
public class GenerateRandomNumbersProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		for (int i = 0; i < requestCount.intValue(); i++) {
			...
			int number = new Random().nextInt(requestRange.intValue() - 1) + 1;
